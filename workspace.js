...
cprequire_test(["inline:com-chilipeppr-workspace-d1"], function(ws) {
    ...
    $('title').html("d1 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-d1", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-d1", // Make the id the same as the cpdefine id
        name: "Workspace / d1", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace d1 for MM.`,
...
//            this.loadLuaEditorWidget();
        ...
        loadGcodeWidget: function(callback)
        {
            chilipeppr.load(
                ...
                function() {
                    ...
                    // Now use require.js to get reference to instantiated widget
                    cprequire(
                        ["inline:widget-gcode-instance"], // the id you gave your widget
        ...
        loadSpjsWidget: function(callback) {
            ...
            chilipeppr.load(
                ...
                "http://fiddle.jshell.net/chilipeppr/8d2ce030/show/light/",
                function() {
