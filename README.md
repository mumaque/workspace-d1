# com-chilipeppr-workspace-d1
A ChiliPeppr Workspace d1 for MM.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / d1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-d1 |
| Name                  | Workspace / d1 |
| Description           | A ChiliPeppr Workspace d1 for MM. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/mumaque/workspace-d1/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/mumaque/workspace-d1 |
| Github URL            | http://github.com/mumaque/workspace-d1 |
| Test URL              | https://preview.c9users.io/mumaque/workspace-d1/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/mumaque/workspace-d1/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-d1"], // the id you gave your workspace
      function(myWorkspaceD1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / d1 just got loaded.", myWorkspaceD1);
        myWorkspaceD1.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-d1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / d1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace d1 for MM."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/mumaque/workspace-d1/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/mumaque/workspace-d1"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/mumaque/workspace-d1"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-d1-mumaque.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadCurrSensWidget</td><td>function</td><td>function ()</td></tr><tr valign="top"><td>loadGcodeWidget</td><td>function</td><td>function (callback)</td></tr><tr valign="top"><td>loadLuaEditorWidget</td><td>function</td><td>function (callback) <br><br>Load the Lua Editor widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial Port JSON Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadAxesWidget</td><td>function</td><td>function (callback)</td></tr><tr valign="top"><td>load3DviewerWidget</td><td>function</td><td>function (callback)</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
